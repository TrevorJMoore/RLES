...
public class FuelTankTemperatureSensor extends Sensor {

	public FuelTankTemperatureSensor(int sensorId, String sensorName, DataType measurementType, int unitCode) {
